...
import adapter.URL_All_List_Adapter_Recycler;
import helper.SQLiteHandler;
import helper.SessionManager;

public class MainActivity_Select_Option extends AppCompatActivity implements ZXingScannerView.ResultHandler {
   // private ZXingScannerView mScannerView;
    ArrayList<HashMap<String, String>> arrayList_stations;
    RecyclerView list_word;
    public static URL_All_List_Adapter_Recycler mListview_Friends_Chat_Adapter_Recycler =null;
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreference mSharedPreference = new SharedPreference(MainActivity_Select_Option.this);
        if(mSharedPreference.get_isUserLoggedIn()) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    list_word.setLayoutManager(new GridLayoutManager(this, 2));
                    list_word.setHasFixedSize(true);
                //    mScannerView = (ZXingScannerView) findViewById(R.id.view);
            ...
            Intent  intent= new Intent(MainActivity_Select_Option.this, MainActivity_Initial.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_logout:
                showMessageOKCancel_one_sms(MainActivity_Select_Option.this, "Confirmación",
                        information_user.get_email(),
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                logout logout = new logout(MainActivity_Select_Option.this);
                                logout.execute();
                            }
                        },null);
                break;
    ...
    public   class logout extends AsyncTask<Integer, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            if(result==1){
                ...
                Intent  MainActivity_Points= new Intent(ctx, MainActivity_Initial.class);
