...
public class MainActivity_Initial_QR extends AppCompatActivity implements View.OnClickListener {
  private  TextInputLayout input_layout_editText_name;
    private  TextInputLayout   input_layout_editText_password;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        SharedPreference mSharedPreference = new SharedPreference(MainActivity_Initial_QR.this);
                        ...
                        Intent  intent= new Intent(MainActivity_Initial_QR.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
    ...
    private void showDialog() {
      try {
          if (!pDialog.isShowing())
              pDialog.show();
      }catch(NullPointerException ee){ee.printStackTrace();}catch (java.lang.IllegalArgumentException ee){ee.printStackTrace();}
    }
